...
from Detection.yolo_pose_detector import detect_theft_yolo_pose
...
def run_yolo_pose_pipeline(video_path=None):
    ...
    print("\n" + "=" * 70)
    print("YOLO POSE THEFT DETECTION PIPELINE")
    print("=" * 70)
    print(f"Video: {theft_video_path}")
    print(f"Model: YOLO Pose Estimation + LSTM")
    print("=" * 70 + "\n")

    print("\n[1/3] Running YOLO Pose-based behavior detection (OPTIMIZED)...")
    ...
    print("\n" + "=" * 70)
    print("YOLO POSE PIPELINE COMPLETE")
    print("=" * 70)
    print("✓ Theft detected and reported")
    print(f"✓ Video: {theft_video_path}")
    print(f"✓ Person: {face_info}")
